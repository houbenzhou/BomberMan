...
public class Player extends DynamicImage {
    ...
    public void doAnimation() {
        ...
        if (mPlayerHorizontalDirection != 0) {
            nowDirection = mPlayerHorizontalDirection;
        } else {
            nowDirection = mPlayerVerticalDirection;
        }

        if (nowDirection != 0 && nowDirection != mPreDirection) {
            setFrameBitmap(mFrameBitmaps.get(nowDirection));
            mPreDirection = nowDirection;
        }
